...
function AdminUsersPage() {
    ...
    const fetchUsers = async ()=>{
        setLoading(true);
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getUsers(1, 50, searchTerm);
    ...
    const updateUserStatus = async (userId, status)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].updateUserStatus(userId, status === 'Active');
    ...
    const updateVerificationStatus = async (userId, verificationStatus)=>{
        try {
            if (verificationStatus === 'Verified') {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].verifyUser(userId);
            }
            fetchUsers(); // Refresh the list
        } catch (error) {
...
//# sourceMappingURL=src_2740704d._.js.map