...
function AdminUsersPage() {
    ...
    const [selectedUserType, setSelectedUserType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const fetchUsers = async ()=>{
        setLoading(true);
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getUsers(1, 50, searchTerm);
    ...
    const updateUserStatus = async (userId, status)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].updateUserStatus(userId, status === 'Active');
    ...
    const updateVerificationStatus = async (userId, verificationStatus)=>{
        try {
            if (verificationStatus === 'Verified') {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].verifyUser(userId);
            }
            fetchUsers(); // Refresh the list
        } catch (error) {
...
//# sourceMappingURL=src_af424795._.js.map