...
function AdminCategoriesPage() {
    ...
    const onSubmit = async (data)=>{
        try {
            const token = localStorage.getItem("authToken");
            const url = selectedCategory ? `${process.env.NEXT_PUBLIC_API_URL}/admin/categories/${selectedCategory.id}` : `${process.env.NEXT_PUBLIC_API_URL}/admin/categories`;
...
//# sourceMappingURL=src_810be19f._.js.map